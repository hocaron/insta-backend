/*
  ...
  - You are about to drop the column `hashatag` on the `Hashtag` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Hashtag.hashatag_unique";

-- AlterTable
ALTER TABLE "Hashtag" DROP COLUMN "hashatag",
